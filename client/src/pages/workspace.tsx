                  ...
                  <AccordionItem value="ver-2.0.15" className="border border-border rounded-lg px-4">
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      ...
                      <ul className="list-disc ml-5 space-y-1.5 text-sm text-muted-foreground">
                        ...
                        <li><strong className="text-foreground font-medium">Discovered libraries</strong> &mdash; a new section at the bottom of the LDM that surfaces libraries PDR has Fixed photos to in the past but that aren&apos;t in your LDM list right now. Reads the cumulative <code>indexed_runs</code> table (built up by every Fix run since v2.0.5) and lists only paths that still exist on disk. Each card shows the path, when you last Fixed to it, how many Fix runs landed there, and the total file count &mdash; with one-click <strong className="text-foreground font-medium">Add to list</strong> or <strong className="text-foreground font-medium">Ignore</strong> actions. Ignored libraries stay hidden across restarts. Useful when you&apos;ve outgrown an earlier drive (e.g. moved from a USB stick to a 2 TB drive) and want to find or relink your old library folders &mdash; the database has been quietly remembering every destination all along; this section just exposes the memory.</li>
