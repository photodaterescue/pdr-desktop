                  ...
                  <AccordionItem value="ver-2.0.15" className="border border-border rounded-lg px-4">
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      ...
                      <ul className="list-disc ml-5 space-y-1.5 text-sm text-muted-foreground">
                        ...
                        <li><strong className="text-foreground font-medium">Discovered libraries</strong> &mdash; a new section at the bottom of the LDM that surfaces libraries PDR has Fixed photos to in the past but that aren&apos;t in your LDM list right now. Three discovery strategies, layered by confidence:
                          <ul className="list-disc ml-5 mt-1.5 space-y-1">
                            ...
                            <li><strong className="text-foreground font-medium">PDR catalogue found on disk</strong> (manual, deep) &mdash; click <em>Scan drives for more</em> to walk every connected drive looking for <code>PDR_Catalogue.csv</code> files. Each catalogue&apos;s contents are parsed for distinct destination paths, so a single CSV can reveal several historical libraries.</li>
                            <li><strong className="text-foreground font-medium">Folder structure looks like PDR</strong> (manual, deep) &mdash; same scan finds folders matching PDR&apos;s year-based output structure (year folders containing year-month subfolders). Weaker signal than the catalogue file (Lightroom and manual organisers produce similar trees), so cards are amber-badged to set expectations.</li>
                          </ul>
                          Each card has one-click <strong className="text-foreground font-medium">Add to list</strong> or <strong className="text-foreground font-medium">Ignore</strong> actions; ignored libraries stay hidden across restarts. The drive scan is depth-capped at 6 levels and skips OS-system folders, so it stays bounded even on multi-terabyte external drives.</li>
