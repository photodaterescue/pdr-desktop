                  ...
                  <AccordionItem value="ver-2.1" className="border border-border rounded-lg px-4">
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      ...
                      <ul className="list-disc ml-5 space-y-1.5 text-sm text-muted-foreground">
                        ...
                        <li><strong className="text-foreground font-medium">AI Photo Enhancement &mdash; CodeFormer + Real-ESRGAN</strong> &mdash; first-party models, downloaded on demand. Available from the Viewer Enhance panel: face restoration (CodeFormer), upscaling (Real-ESRGAN), or both. Enhanced files save with an <code>_E</code> filename suffix and XMP metadata recording the enhancement method. Search &amp; Discovery filter chip surfaces Manual / AI-Enhanced / Original variants. (Panel currently hidden behind a feature flag pending a final UX pass.)</li>
