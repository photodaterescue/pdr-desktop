...
const SOURCE_META: Record<string, { label: string; colour: string; icon: any; explain: string }> = {
  neighbour: { label: 'Neighbor',  colour: 'bg-blue-500/15 text-blue-600 dark:text-blue-400',       icon: ArrowLeftRight, explain: 'Midpoint between Confirmed photos before and after in the same folder.' },
