                  ...
                  >
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      ...
                      <details className="mt-3 pt-3 border-t border-border/60 group">
                        ...
                        <li><strong className="text-foreground font-medium">Date Editor unlocked</strong> &mdash; the Date Editor surface is now live in the sidebar, ribbon, and Welcome screen for every install. (Trees still pending unlock; same pattern.)</li>
