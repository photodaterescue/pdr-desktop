                  ...
                  <div className="px-4 pb-4 space-y-3 border-t border-border pt-3">
                    ...
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-muted-foreground">If you renamed or reorganized the Library Drive, use <strong>Relocate</strong> to browse to its new location. All your search and AI data will be preserved.</p>
                      </div>
                    </div>
