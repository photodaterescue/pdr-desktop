...
openExternal: (url: string) => ipcRenderer.invoke('shell:openExternal', url),
  ...
  viewer: {
    ...
    saveEnhanced: (req: {
      filePath: string;
      mode: 'new' | 'replace';
      filterState: { brightness: number; contrast: number; saturation: number; temperature: number; bw: boolean; bwTint?: string; tone?: 'none' | 'sepia' | 'vintage'; borderColor?: string; borderWeight?: 'thin' | 'mat' };
