                      ...
                      <ul className="list-disc ml-5 space-y-1.5 text-sm text-muted-foreground">
                        ...
                        <li><strong className="text-foreground font-medium">Discovered libraries</strong> &mdash; a new section at the bottom of the LDM that surfaces libraries PDR has Fixed photos to in the past but that aren&apos;t in your LDM list right now. Two authoritative discovery sources:
                          <ul className="list-disc ml-5 mt-1.5 space-y-1">
                            ...
                            <li><strong className="text-foreground font-medium">PDR catalogue found on disk</strong> (manual, deep) &mdash; click <em>Scan drives for more</em> to walk every connected drive looking for <code>PDR_Catalogue.csv</code> files. Each catalogue&apos;s contents are parsed for distinct destination paths, so a single CSV can reveal several historical libraries. The catalogue file presence is the only signal used &mdash; folders without an associated catalogue are never flagged, so no false positives from year-based personal organisation.</li>
                          </ul>
