                  ...
                  <AccordionItem value="ver-2.1" className="border border-border rounded-lg px-4">
                    ...
                    <AccordionContent className="pt-2 pb-4">
                      <p className="text-sm text-muted-foreground mb-3 leading-relaxed">
                        <strong className="text-foreground">Video transcription, AI photo enhancement, the Date Editor unlock, and a deep refresh of Search &amp; Discovery and Memories with matching toolbar pills, a gold selection banner, a Show-Preview placeholder, and a one-click round-trip to Parallel Library.</strong> The view-pill recipe and the selection-banner recipe are now shared across Search &amp; Discovery, Memories &mdash; Dates, Memories &mdash; Albums, and Needs Dates, so the four surfaces look and behave as one family.
                      </p>
